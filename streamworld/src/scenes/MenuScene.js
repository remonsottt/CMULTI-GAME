// Title screen and zone selector
export class MenuScene extends Phaser.Scene {
    ...
    create() {
        ...
        // Animated "data packets" in background
        this.packets = [];
        for (let i = 0; i < 15; i++) {
            const p = this.add.rectangle(
                ...
                6, 6,
                Phaser.Utils.Array.GetRandom([0x1D9E75, 0x378ADD, 0xEF9F27]),
                0.5
            );
        ...
        const tableX = W / 2 - 260;
        const tableY = 185;
        this._drawTable(tableX, tableY);
    ...
    _drawTable(x, y) {
        ...
        rows.forEach((row, ri) => {
            ...
            g.fillStyle(bg, 0.9);
            g.fillRect(x, y + ri * rowH, totalW, rowH);
            g.lineStyle(1, 0x334466, 1);
            g.strokeRect(x, y + ri * rowH, totalW, rowH);
